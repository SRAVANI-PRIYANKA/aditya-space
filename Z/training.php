...
<html lang="en">
   ...
   <body id="page-top">
      ...
      <input type="text" name="institute_name"><br><br>
      <label>Worked on the Domain:</label>
      <input type="text" name="domain"><br><br>
      <label>Duration Date-from:<input type="date" name="from_date"></label><br><br>
      <label>to:<input type="date" name="to_date"></label><br><br>
      <label>Total Number Of Days:
        <input type="number" min="1" max="100" name="total_days">
      </label>
      <br><br>
      <label>Upload Certificate:</label>
      <input type="file" name="certificate" id="myFile"><br><br>
